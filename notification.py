...
"""
        ...
        def send(self, doc):
                ...
                print("sending it here , inside send")
                ...
                try:
                        ...
                        print("exception kicked")
                        self.log_error("Failed to send Notification")

                if self.set_property_after_alert:
                        print("property after alert")
                        allow_update = True
                        if (
